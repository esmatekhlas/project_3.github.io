...
if($method=='POST'){
  ...
  $sql = "INSERT INTO `mobile` (`mobile_id`, `mobile_name`, `mobile_type`, `mobile_price`, `mobile_camra`, `mobile_battry`, `mobile_img`, `mobile_info`) VALUES (NULL, '$mobile_name', '$mobile_type', '$mobile_price','$mobile_camra', '$mobile_battry', '$mobile_img','$, '$mobile_info'');";
            ...
            <div class="card" style="border-radius: 1rem;">
              <div class="card-body p-5">
                ...
                <form action="<?php $_SERVER['REQUEST_URI']?>" method="POST">
                  ...
                  <div class="form-outline mb-4">
                    <textarea class="form-control" name="mobile_info" id="form6Example7" rows="4"></textarea>
                    <label class="form-label" for="form6Example7">Phone info </label>
                  </div>
